      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Thêm thành nhà trọ mới</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Thêm thành nhà trọ mới</h4>
                  ...
                  <form action="" method="POST" id="frm_upload">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                          <input name="toado" type="text" class="form-control" id="toado" placeholder="Vui lòng chọn vị trí trên bản đồ phía dưới!" readonly>
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-row">
                    ...
                    <div class="map_embed" style="width: 100%; height: 43em; padding: 2em;">
                      <div id="mapDiv" style="height: 50em; position: relative; top: 0; cursor: crosshair; border-radius: 2em"></div>
                    </div>
                   <br>

      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Danh sách nhà trọ</a>
          </div>
          ...
          <div class="row">
              <?php 
                  while ($home_post = mysqli_fetch_array($home_list, MYSQLI_ASSOC)) {
                    ...
                    echo "</div>\n";
                    echo "<a href=\"homestatus.php?id=".$home_post["id_home"]."\" title=\"Duyệt\"><button class=\"btn_suanhatro\">Duyệt</button></a>\n";
                    echo "<a href=\"delete_home.php?id=".$home_post["id_home"]."\" title=\"Xóa\"><button class=\"btn_suanhatro\" style=\"background-color: #d40303;\" onClick=\"return confirm('Are you sure you want to delete?');\">Xóa</button></a>\n";
                    echo "</div>\n";
                    echo "</div>\n";
                    echo "</div>";
                  }

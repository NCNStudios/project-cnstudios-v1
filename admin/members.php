...
if($gClient->getAccessToken()){
    ...
    if($rank != "Admin"){
      ...
      $query_get_list_members = "SELECT * FROM users";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Thành viên đăng ký</a>
          </div>
                    ...
                    <tbody>
                      <?php 
                        while ($members_post = mysqli_fetch_array($members_list, MYSQLI_ASSOC)) {
                          ...
                          echo "<td>".$members_post["rank"]."</td>\n";
                          echo "<td>".$members_post["created"]."</td>\n";
                          echo "<td><a href=\"edit_member.php?id=".$members_post["id"]."\" title=\"Xác minh tài khoản\"><button class=\"btn_taohoadon\">Sửa</button></a></td>\n";
                          echo "</tr>";
                        }
                    ?>
                    </tbody>

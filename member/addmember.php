...
if($gClient->getAccessToken()){
    ...
    if($rank != "Member"){
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql2 = "INSERT INTO members (id_home,tennhatro, ten_members, que_quan, sdt, phong, ngaybd, ngaythemuser, oauth_uid) VALUES ('$mem_idnt', '$tennt', '$mem_hoten', '$mem_quequan', '$mem_sdt', '$mem_phong', '$mem_ngaybdthue', '$date_modified', '$uid')"; 
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Thêm thành viên mới</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Thêm thành viên mới</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="phong">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="start_datepicker" name="ngaybdthue">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="sel_loaiphong" name="nhatro">
                            <?php 
                                while ($home_post = mysqli_fetch_array($home_list, MYSQLI_ASSOC)) {
                                    echo "<option value=\"".$home_post["id_home"]."\">".$home_post["tennhatro"]."</option>";
                                }
                            ?>

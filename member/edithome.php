      ...
      if(isset($_REQUEST["id"]))
            {
              ...
              //Lấy giá trị POST từ form vừa submit
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql2 = "UPDATE homes SET tennhatro='$ten_nha_tro', vi_tri='$vi_tri', coordinates='$coord', mo_ta='$mo_ta', loai_nha_tro='$loai_nt', khu_vuc='$khu_vuc', anh_bia='$anh_bia' WHERE id_home = '".$_REQUEST['id']."'"; 
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Sửa thông tin nhà trọ</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Sửa thông tin nhà trọ</h4>
                ...
                <div class="card-body">
                  <form action="" method="POST" id="frm_upload">
                    <div class="form-group">
                        <input name="tennhatro" type="text" class="form-control" id="tennhatro" placeholder="Tên nhà trọ..." value="<?php echo $ten_nt ?>">
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-8">
                          <input name="vitri" type="text" class="form-control" id="vitri" placeholder="Vị trí nhà trọ..." value="<?php echo $vi_tri ?>">
                      </div>
                      <div class="form-group col-md-4">
                          <input name="toado" type="text" class="form-control" id="toado" placeholder="Vui lòng chọn vị trí trên bản đồ phía dưới!" readonly value="<?php echo $coord ?>" >
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-row">
                        <p class="text-danger" style="font-style: italic;">*Giá phòng vui lòng sửa chữa tại <a href="pricelist.php">Bảng giá dịch vụ</a></p>
                    </div>
                    <div class="line"></div>
                    <div class="form-group">
                        <textarea name="mota" class="form-control mota" id="mota" rows="3" placeholder="Mô tả..."><?php echo $mo_ta ?></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label class="font-weight-bold" for="exampleFormControlFile1">Loại nhà trọ</label>
                            <br/>
                            <input type="checkbox" name="chk_binhthuong" value="Bình thường"><label for="chk_binhthuong" style="margin-right: 10px;"> Bình thường</label>
                            <input type="checkbox" name="chk_nhatronu" value="Nhà trọ nữ"><label for="chk_nhatronu" style="margin-right: 10px;"> Nhà trọ nữ</label>
                            <input type="checkbox" name="chk_cogac" value="Bình thường"><label for="chk_cogac" style="margin-right: 10px;"> Có gác</label>
                            <input type="checkbox" name="chk_khonggac" value="Nhà trọ nữ"><label for="chk_khonggac"> Không gác</label>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="font-weight-bold" for="exampleFormControlFile1">Chọn khu vực</label>
                  ...
                  <button name="video-upload" type="submit" class="btn btn-primary">Cập nhật  <i class="fab fa-superpowers fa-spin"></i></button>
                </form>

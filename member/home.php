...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <a href="addhome.php" title="Thêm nhà trọ"><button class="btn_themnhatro">Thêm nhà trọ</button></a>
          <div class="row">
              <?php 
                  while ($home_post = mysqli_fetch_array($home_list, MYSQLI_ASSOC)) {
                    ...
                    echo "</div>\n";
                    echo "<a href=\"edithome.php?id=".$home_post["id_home"]."\" title=\"Sửa\"><button class=\"btn_suanhatro\">Sửa</button></a>\n";
                    echo "</div>\n";
                    echo "</div>\n";
                    echo "</div>";
                  }
